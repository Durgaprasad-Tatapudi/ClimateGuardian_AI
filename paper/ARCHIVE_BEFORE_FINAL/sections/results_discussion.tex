...
Predicting Compound hazards requires differentiating offline theoretical capacity from operational deployment feasibility (Table~\ref{tab:op_selection}). The Logistic Regression Stacking Ensemble achieved the strongest predictive discrimination for the Compound target, recording an $F_1$-score of 0.4074, an ROC-AUC of 0.9487, and a PR-AUC of 0.3651. In comparison, the GRU offline benchmark achieved an $F_1$-score of 0.3265, an ROC-AUC of 0.9278, and a PR-AUC of 0.2675. 
