...
The simultaneous intersection of hazards introduces significant predictive complexity. The operational Stacking Ensemble yields an $F_1$-score of 0.4237 and an ROC-AUC of 0.9434. The GRU sequential benchmark achieved an $F_1$-score of 0.4444 and an ROC-AUC of 0.9629. This confirms that the stateless ensemble architecture outperformed the deep learning sequence benchmark under the evaluated conditions.
